...
contract CCIPTokenSenderFujiSepolia {
    ...
    //bnb token (burn and mint token) burning the token on the source blockchain and minting it on the destination 
   ...
   // event log that can be monitored with block explorer
