...
contract CrossChainPriceNFT is ERC721, ERC721URIStorage {
    ...
    //https://docs.chain.link/ccip/supported-networks/testnet  --> CCIP codes
    ...
    // Update MetaData (We generate the image inside the smart contract)
    function updateMetaData(uint256 tokenId, uint256 sourceId) public {
        // Create the SVG string
        string memory finalSVG = buildSVG(sourceId);

        // Base64 encode the SVG -- NFT metadata created on-chain
